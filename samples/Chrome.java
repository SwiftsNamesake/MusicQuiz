...
class Chrome extends Application {
...
//The FlowPane is a conatiner that uses a flow layout
		final FlowPane choicePane = new FlowPane(); choicePane.setHgap(100); Label choiceLbl = new Label("Fruits");  
...
//The button uses an inner class to handle the button click event
		...
		vegFruitBut.setOnAction(new EventHandler() {  @Override public void handle(ActionEvent event) { 
